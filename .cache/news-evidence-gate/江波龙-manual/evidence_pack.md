...
| Key | Value |
|---|---|
| Audit Time | 2026-07-04T20:28:29 |
...
- [cninfo_official_disclosure] 江波龙2026年半年度业绩预告：预计营业收入220.00亿元至250.00亿元，归母净利润92.00亿元至110.00亿元 (earnings_revision)
...
- price_volume:sina_quote failed: urlopen failed: <urlopen error [WinError 10013] 以一种访问权限不允许的方式做了一个访问套接字的尝试。>; curl fallback failed code=7: curl: (7) Failed to connect to hq.sinajs.cn port 443 after 5 ms: Could not connect to server

- price_volume:eastmoney_kline failed: urlopen failed: <urlopen error [WinError 10013] 以一种访问权限不允许的方式做了一个访问套接字的尝试。>; curl fallback failed code=7: curl: (7) Failed to connect to push2his.eastmoney.com port 443 after 7 ms: Could not connect to server
